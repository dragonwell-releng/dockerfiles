...
RUN wget http://dragonwell.oss-cn-shanghai.aliyuncs.com/8%2Fx64%2F8.3.3-rc0-bootstrap%2Falibaba_dragonwell_8.3.3_rc0_bootstrap.tar.gz && tar xvf alibaba_dragonwell_8.3.3_rc0_bootstrap.tar.gz -C /opt/ && mv /opt/j2sdk-image /opt/dragonwell_8.3.3_boot && wget https://ci.adoptopenjdk.net/view/all/job/jtreg/lastSuccessfulBuild/artifact/jtreg-4.2.0-tip.tar.gz && tar xvf jtreg-4.2.0-tip.tar.gz -C /opt/ && rm -rf *.tar.gz
